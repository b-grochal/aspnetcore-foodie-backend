...
namespace Foodie.Orders.Infrastructure.Database.SqlQueries
{
    ...
    {
        private readonly IDbConnecionFactory _connectionFactory;

        public GetMyOrderByIdSqlQuery(IDbConnecionFactory dapperContext, IMapper mapper)
        {
            _connectionFactory = dapperContext;
        }
